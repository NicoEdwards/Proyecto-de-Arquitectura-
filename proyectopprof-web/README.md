# TypeScript + Deno + Next.js

This project was generated with: `deno run -A npm:create-next-app@latest`
...
- `deno task build`: Build app to for additional typechecking

2. Launch App

- copy `.env.dev` to `.env`: Create .env file
- `deno task dev`: Run app in development mode
- "http://localhost:3000": Access client

## Production Demo

- "https://cris-proyectoppr-71.deno.dev": Access client
